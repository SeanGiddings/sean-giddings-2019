  ...
  return (
    <div className="LandingPage">
      ...
      <FeaturedSection 
          image={Colyer} 
          title='Web Developer' 
          description='<a href="http://www.colyerqualitybuilt.com">ColyerQualityBuilt.com</a> (and the portfolio you’re currently looking at!) 
          were designed and built from the ground up by yours truly. I utilized a wordpress framework to build Ron Colyer’s site, focusing on 
          scalability and responsiveness, so that his site would look clean and professional on any sized screen. This portfolio was built using ReactJS, 
